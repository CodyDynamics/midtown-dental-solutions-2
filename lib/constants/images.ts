/** Raster placeholders (original HTML referenced .webp files not shipped in repo). */
export const IMAGES = {
  hero:
...
export const AVATARS = [
  ...
  "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?auto=format&fit=crop&w=200&h=200&q=80",
] as const;
